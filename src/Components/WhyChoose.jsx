...
const WhyChooseUs = () => {
  ...
  const features = [
    {
      ...
      description:
        "Direct partnerships with Dell, HP, Acer, Apple, and Lenovo ensure genuine products with official warranties",
    ...
    },
    {
      ...
      description:
        "Lightning-fast delivery across India with real-time tracking and secure packaging",
    ...
    },
    {
      ...
      description:
        "Comprehensive coverage beyond manufacturer warranty with doorstep service support",
    ...
    },
    {
      ...
      description:
        "Hassle-free returns and exchanges with full refund guarantee if not satisfied",
    ...
    },
    {
      ...
      description:
        "0% interest EMI available on all major credit cards and buy-now-pay-later options",
    ...
    },
    {
      ...
      description:
        "Dedicated tech experts available round the clock for pre & post-purchase assistance",
  ...
  const testimonials = [
    {
      name: "Rahul Sharma",
      review:
        "Amazing experience! Got my Dell XPS delivered in 2 days with perfect packaging.",
      rating: 5,
    ...
    },
    {
      name: "Priya Patel",
      review:
        "Best prices in market and excellent customer service. Highly recommended!",
      rating: 5,
    ...
    },
    {
      name: "Amit Kumar",
      review:
        "EMI options made it so affordable. Got HP Pavilion for my studies.",
      rating: 5,
  ...
  return (
    <div className=" py-16  overflow-hidden container-box">
      <div className="l mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-16">
          <div className="text-center transform hover:scale-105 transition-transform duration-300">
            <div className="bg-blue-300 rounded-2xl p-6 shadow-lg border-2 border-blue-100 hover:border-blue-300">
          ...
          <div className="text-center transform hover:scale-105 transition-transform duration-300">
            <div className="bg-blue-300 rounded-2xl p-6 shadow-lg border-2 border-green-100 hover:border-green-300">
          ...
          <div className="text-center transform hover:scale-105 transition-transform duration-300">
            <div className="bg-blue-300 rounded-2xl p-6 shadow-lg border-2 border-yellow-100 hover:border-yellow-300">
          ...
          <div className="text-center transform hover:scale-105 transition-transform duration-300">
            <div className="bg-blue-300 rounded-2xl p-6 shadow-lg border-2 border-purple-100 hover:border-purple-300">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
              ...
              return (
                <div
                  ...
                  className={`cursor-pointer p-6 rounded-2xl transition-all duration-500 border-2 ${
                    isActive
                      ? "bg-blue-300 shadow-xl border-blue-300 scale-105"
                      : "bg-blue-300/70 hover:bg-blue-300 border-gray-200 hover:border-blue-200 hover:scale-102"
                  }`}
                >
          ...
          <div className="bg-blue-300 rounded-3xl p-8 shadow-xl border border-gray-200">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
              {brands.map((brand, index) => (
                <div
                  key={brand.name}
                  className="text-center flex flex-col items-center p-4 rounded-xl bg-gradient-to-br from-gray-50 to-blue-50 hover:from-blue-50 hover:to-purple-50 transition-all duration-300 hover:scale-105 border border-gray-200 hover:border-blue-300"
                >
                  <img
                    className="text-4xl mb-2 max-w-[100px]"
                    src={brand.logo}
                  />
        ...
        <div className="bg-blue-300 rounded-3xl p-8 shadow-xl border border-gray-200 mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {testimonials.map((testimonial, index) => (
              <div
                key={index}
                className="text-center p-6 bg-gradient-to-br from-blue-50 to-purple-50 rounded-2xl border border-blue-200"
              >
        ...
        <div className="bg-gradient-to-r from-blue-600 to-purple-600 rounded-3xl p-8 md:p-12 text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <button className="bg-blue-300 text-blue-600 px-8 py-4 rounded-2xl font-bold text-lg hover:scale-105 transform transition-all duration-300 shadow-lg">
              Browse Laptops
            </button>
            <button className="border-2 border-white px-8 py-4 rounded-2xl font-bold text-lg hover:bg-blue-300 hover:text-blue-600 transition-all duration-300">
              Talk to Expert
            </button>
          </div>
